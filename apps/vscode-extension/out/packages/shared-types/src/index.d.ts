...
export type CliEventType = 'run.started' | 'run.progress' | 'run.completed' | 'trace.started' | 'trace.progress' | 'trace.completed' | 'finding' | 'report.created' | 'approval.required' | 'error';
...
export type EventRole = 'validation' | 'authorization' | 'business_logic' | 'db' | 'external_call';
...
export type FindingCategory = 'behavior_change' | 'race_condition' | 'rate_limit' | 'idempotency' | 'retry_storm' | 'security_authentication' | 'security_authorization' | 'security_sensitive_data' | 'security_injection' | 'security_mass_assignment' | 'performance' | 'data_integrity' | 'tracegraph_policy_change';
export type Finding = {
    id: string;
